...
export default function AdminProductList() {
  ...
  useEffect(() => {
    ...
    const pagination = { per_page: ITEMS_PER_PAGE, _page: page };
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <Link
                  ...
                  className="rounded-md ml-10 bg-green-600 mt-3 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Add New Product
                </Link>
            ...
            {products.map((product) => (
              <div>
                ...
                <Link
                  ...
                  className="rounded-md mt-5 ml-2 bg-red-700 px-3 py-2 text-sm font-semibold text-white  hover:bg-red-800  shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Edit Product
                </Link>
                </div>
